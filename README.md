...
The barrier for solving the second version of the environment is slightly different than the first version, to take into account the presence of many agents.  In particular, your agents must get an average score of +30 (over 100 consecutive episodes, and over all agents).  Specifically,
...
```bash
git clone https://github.com/YoussefBenDhieb/Continuous-Control-PPO.git
